      ...
      <div className="flex-1 flex flex-col overflow-hidden pt-[60px] md:pt-0">
        <main className="flex-1 overflow-y-auto bg-background p-4 md:p-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
            <h1 className="text-2xl font-bold text-neutral-800">My Cards</h1>
            ...
            <CardContent className="pt-6">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="bg-neutral-50 p-4 rounded-lg">
                  <h4 className="text-sm font-medium text-neutral-600">Total Cards</h4>
                ...
                <div className="bg-neutral-50 p-4 rounded-lg">
                  <h4 className="text-sm font-medium text-neutral-600">Total Points</h4>
                  <p className="text-2xl font-bold mt-1">
                    {isLoading ? (
                      <Loader2 className="h-6 w-6 animate-spin text-primary" />
                ...
                <div className="bg-neutral-50 p-4 rounded-lg">
                  <h4 className="text-sm font-medium text-neutral-600">Banks</h4>
                  <p className="text-2xl font-bold mt-1">
                    {isLoading ? (
                      <Loader2 className="h-6 w-6 animate-spin text-primary" />
          ...
          {/* Card Management */}
          <div className="mb-6">
            <h2 className="text-lg font-semibold text-neutral-800 mb-4">Manage Your Cards</h2>
